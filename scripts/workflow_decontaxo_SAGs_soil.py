...
#extraction of the blacklist contaminant
...
args = f"{run_dir} {list_ids_sh} {suffix} {output} {conda_env}"
...
args_final = f"{run_dir} {list_ids_sh} {suffix} {output}  {conda_env} {kraken_db}"
launch_sarray("kraken_final", nb_files, task_for_kraken, args_final, "kraken_final.sh", suffix) 

### get overall stats on assemblies
args_final = f"{run_dir} {list_ids_sh} {suffix} {output}  {conda_env}"
